# Platformio IDF Server Project

This project sets up an HTTP server on an ESP32 using the PlatformIO framework. The server responds with a simple HTML page when accessed.
...
1. Set up the PlatformIO environment:
    ```sh
...
The main code for this project is in web_server.c:
