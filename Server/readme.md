# IDF HTTP Server Project

This project sets up an HTTP server on an ESP32 using the ESP-IDF framework. The server responds with a simple HTML page when accessed.
...
2. Create the project:
    ```sh
    idf.py create-project -p . Http_server
    ```
